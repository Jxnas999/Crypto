              ...
              coins.map((item) => {
                return (
                  ...
                  >
                    ...
                    <td>
                    {watchlistItems?.find(element => element.coin == item.id)? <AiFillHeart onClick={event => handleWatchlist(item.id)}/> : <AiOutlineHeart onClick={event => handleWatchlist(item.id)}/>}
